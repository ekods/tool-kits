...
function tk_geo_save(): void {
    ...
    $allowed_tabs = array('overview', 'custom-jsonld', 'faqpage', 'itemlist', 'llms', 'ai-visibility', 'prompt-preview', 'post-schema', 'schema-duplicates', 'crawler-preview', 'ai-access', 'preview');
            ...
            <?php if (!empty($visibility_report)) : ?>
                ...
                <div id="tk-geo-visibility-report">
                    ...
                    <div class="tk-grid tk-grid-3" style="gap:16px; margin:14px 0;">
                        ...
                        <div class="tk-card"><strong>Schema Types</strong><br><code><?php echo esc_html(wp_json_encode($visibility_schema['types'] ?? array(), JSON_UNESCAPED_SLASHES)); ?></code></div>
                    </div>
                ...
                <div id="tk-geo-prompt-report">
                    ...
                    <table class="widefat striped tk-table">
                        <tbody>
                            ...
                            <tr><th>Schema Types</th><td><code><?php echo esc_html(wp_json_encode($prompt_types, JSON_UNESCAPED_SLASHES)); ?></code></td></tr>
                ...
                <div id="tk-geo-post-schema-report">
                    ...
                    <table class="widefat striped tk-table">
                        <tbody>
                            ...
                            <tr><th>Types</th><td><code><?php echo esc_html(wp_json_encode($post_schema['types'] ?? array(), JSON_UNESCAPED_SLASHES)); ?></code></td></tr>
                            <tr><th>Duplicates</th><td><code><?php echo esc_html(wp_json_encode($post_schema['duplicates'] ?? array(), JSON_UNESCAPED_SLASHES)); ?></code></td></tr>
