...
function tk_render_spam_protection_page($forced_tab = '') {
    ...
    $allowed_tabs = array('captcha', 'antispam', 'antispam-log');
    ...
    <div class="wrap tk-wrap">
        ...
        <div class="tk-tabs tk-spam-tabs">
            <div class="tk-tabs-nav">
                ...
                <button type="button" class="tk-tabs-nav-button<?php echo $active_tab === 'antispam-log' ? ' is-active' : ''; ?>" data-panel="antispam-log">Anti-spam Log</button>
            </div>
            <div class="tk-tabs-content">
                ...
                <div class="tk-tab-panel<?php echo $active_tab === 'antispam-log' ? ' is-active' : ''; ?>" data-panel-id="antispam-log">
                    <?php tk_render_antispam_log_panel(); ?>
                </div>
            </div>
        </div>
        <script>
